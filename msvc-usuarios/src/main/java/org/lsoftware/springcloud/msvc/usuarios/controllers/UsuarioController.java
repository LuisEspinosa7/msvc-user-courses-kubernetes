package org.lsoftware.springcloud.msvc.usuarios.controllers;

import org.lsoftware.springcloud.msvc.usuarios.models.entity.Usuario;
import org.lsoftware.springcloud.msvc.usuarios.services.UsuarioService;
    ...
    public ResponseEntity<?> editar(@Valid @RequestBody Usuario usuario, BindingResult result, @PathVariable Long id) {
        ...
        if (o.isPresent()) {
            ...
            if (!usuario.getEmail().isEmpty() &&
                ...
                return ResponseEntity.badRequest()
                        .body(Collections
                                .singletonMap("mensaje", "Ya existe un usuario con ese email electroonico!"));
            }
